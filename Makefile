...
OBJS         = $(MQTTOBJS) $(LOBJS) main.o daemon.o wsactions.o hass.o hasp.o websock.o webservice.o deconz.o lmc.o lmccom.o
OBJS        += growatt.o
...
cppchk:
	cppcheck --enable=all $(CPPCHECK_SUPPRESS) --language=c++ --template="{file}:{line}:1 {severity}:{id}:{message}" --quiet --force --std=c++20 *.c; \
